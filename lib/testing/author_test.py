...
#         """title is longer than 0 characters"""
#         author = Author("Carry Bradshaw")
#         magazine = Magazine("Vogue", "Fashion")
#         article_1 = Article(author, magazine, "How to wear a tutu with style")

#         assert hasattr(article_1, "title")
#         assert len(article_1.title) > 0
...
#         """article is initialized with an author"""
#         author = Author("Carry Bradshaw")
#         magazine = Magazine("Vogue", "Fashion")
#         article_1 = Article(author, magazine, "How to wear a tutu with style")
...
#         assert article_1.magazine == magazine
